...
//            Packet19EntityAction, Packet53BlockChange, Packet130UpdateSign, WorldProvider, 
//            TileEntitySign, ItemInWorldManager, Packet255KickDisconnect, Packet, 
    ...
    implements ICommandListener
{
    ...
    {
        WorldServer worldserver = mcServer.func_28004_a(playerEntity.dimension);
        field_22003_h = true;
        if(!hasMoved)
        {
    ...
    private void handleSlashCommand(String s)
    {
        ...
        } else if(s.toLowerCase().startsWith("/sky"))
        {
        	 mcServer.configManager.teleportToSkyOrBack(playerEntity);
        } else if(s.toLowerCase().startsWith("/hell"))
        {
        	 mcServer.configManager.func_28168_f(playerEntity);
        } else
