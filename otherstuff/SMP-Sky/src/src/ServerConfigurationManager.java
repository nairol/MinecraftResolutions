...
//            NetLoginHandler, EntityPlayer, Packet4UpdateTime, IPlayerFileData, 
//            NetServerHandler, ChunkProviderServer, Packet9Respawn, Packet3Chat, 
//            NetworkManager, PropertyManager, Teleporter, EntityTracker, 
//            ISaveHandler, PlayerManager, ItemInWorldManager, Packet, 
//            TileEntity
...
public class ServerConfigurationManager
{
    ...
    {
        playerNBTManagerObj = aworldserver[0].func_22075_m().func_22090_d();
    }
    ...
    public void func_28172_a(EntityPlayerMP entityplayermp)
    {
        ...
        func_28167_a(entityplayermp.dimension).addPlayer(entityplayermp);
        WorldServer worldserver = mcServer.func_28004_a(entityplayermp.dimension);
    ...
    private PlayerManager func_28167_a(int i)
    {
    	if( i == -1 )
    ...
    public void func_28166_b(EntityPlayerMP entityplayermp)
    {
    ...
    {
        func_28167_a(entityplayermp.dimension).func_543_c(entityplayermp);
    }

    public void playerLoggedOut(EntityPlayerMP entityplayermp)
    {
        playerNBTManagerObj.writePlayerData(entityplayermp);
        mcServer.func_28004_a(entityplayermp.dimension).func_22085_d(entityplayermp);
        playerEntities.remove(entityplayermp);
        func_28167_a(entityplayermp.dimension).removePlayer(entityplayermp);
    }
    ...
    public EntityPlayerMP login(NetLoginHandler netloginhandler, String s)
    {
        ...
        return new EntityPlayerMP(mcServer, mcServer.func_28004_a(0), s, new ItemInWorldManager(mcServer.func_28004_a(0)));
    }

    public EntityPlayerMP recreatePlayerEntity(EntityPlayerMP entityplayermp, int i)
    {
        mcServer.func_28003_b(entityplayermp.dimension).removeTrackedPlayerSymmetric(entityplayermp);
        mcServer.func_28003_b(entityplayermp.dimension).untrackEntity(entityplayermp);
        func_28167_a(entityplayermp.dimension).removePlayer(entityplayermp);
        playerEntities.remove(entityplayermp);
        mcServer.func_28004_a(entityplayermp.dimension).removePlayer(entityplayermp);
        ChunkCoordinates chunkcoordinates = entityplayermp.getSpawnChunk();
        entityplayermp.dimension = i;
        EntityPlayerMP entityplayermp1 = new EntityPlayerMP(mcServer, mcServer.func_28004_a(entityplayermp.dimension), entityplayermp.username, new ItemInWorldManager(mcServer.func_28004_a(entityplayermp.dimension)));
        ...
        {
            ChunkCoordinates chunkcoordinates1 = EntityPlayer.func_25051_a(mcServer.func_28004_a(entityplayermp.dimension), chunkcoordinates);
        ...
        func_28167_a(entityplayermp1.dimension).addPlayer(entityplayermp1);
    ...
    public void func_28168_f(EntityPlayerMP entityplayermp)
    {
        WorldServer worldserver = mcServer.func_28004_a(entityplayermp.dimension);
        int i = 0;
        ...
        entityplayermp.dimension = i;
        WorldServer worldserver1 = mcServer.func_28004_a(entityplayermp.dimension);
        ...
        if(entityplayermp.isEntityAlive())
        {
            ...
            worldserver1.chunkProviderServer.field_28068_a = true;
            (new Teleporter()).func_28115_a(worldserver1, entityplayermp);
            worldserver1.chunkProviderServer.field_28068_a = false;
        }
        ...
        entityplayermp.func_28007_a(worldserver1);
        func_28170_a(entityplayermp, worldserver1);
        func_30009_g(entityplayermp);
    }

    public void teleportToSkyOrBack(EntityPlayerMP entityplayermp)
    {
        WorldServer worldserver = mcServer.func_28004_a(entityplayermp.dimension);
        int i = 0;
        if(entityplayermp.dimension == 1)
        ...
        entityplayermp.dimension = i;
        WorldServer worldserverNew = mcServer.func_28004_a(entityplayermp.dimension);
        entityplayermp.playerNetServerHandler.sendPacket(new Packet9Respawn((byte)entityplayermp.dimension));
        worldserver.removePlayer(entityplayermp);
        entityplayermp.isDead = false;
        if(entityplayermp.isEntityAlive())
        {
            worldserverNew.entityJoinedWorld(entityplayermp);
            entityplayermp.setLocationAndAngles(worldserverNew.worldInfo.getSpawnX(), worldserverNew.worldInfo.getSpawnY(), worldserverNew.worldInfo.getSpawnZ(), entityplayermp.rotationYaw, entityplayermp.rotationPitch);
            worldserverNew.updateEntityWithOptionalForce(entityplayermp, false);
            worldserverNew.chunkProviderServer.field_28068_a = true;
            (new Teleporter()).func_28115_a(worldserverNew, entityplayermp);
            worldserverNew.chunkProviderServer.field_28068_a = false;
        }
        func_28172_a(entityplayermp);
        entityplayermp.playerNetServerHandler.teleportTo(entityplayermp.posX, entityplayermp.posY, entityplayermp.posZ, entityplayermp.rotationYaw, entityplayermp.rotationPitch);
        entityplayermp.func_28007_a(worldserverNew);
        func_28170_a(entityplayermp, worldserverNew);
        func_30009_g(entityplayermp);
    }
    ...
    {
        func_28167_a(l).markBlockNeedsUpdate(i, j, k);
    }
    ...
    public void func_28169_a(Packet packet, int i)
    {
    ...
    public void func_30009_g(EntityPlayerMP entityplayermp)
    {
        entityplayermp.func_28017_a(entityplayermp.personalCraftingInventory);
        entityplayermp.func_30002_B();
    }
